...
int del_root_h(int arr[], int *p_hsize);
void restoreUp(int arr[], int loc);
void restoreDown_h(int arr[], int i, int size);
void buildHeap_ht(int arr[], int size );
void display_ht(int arr[],int hsize);
...
int del_root_h(int arr[], int *size)
{
    int max_2 = arr[1];
    arr[1] = arr[*size];
    (*size)--;
...
void restoreDown_h(int arr[], int i, int hsize )
{
